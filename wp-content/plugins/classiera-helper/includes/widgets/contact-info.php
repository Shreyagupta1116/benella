...
class classiera_Contact_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => esc_html__( 'Contact Info Widget', 'classiera-helper' ),
		);
		parent::__construct( 'classiera_Contact_Info', esc_html__( 'Contact Info Widget', 'classiera-helper' ), $widget_ops );
	}
	...
	public function widget( $argz, $instance ) {
		...
		<div class="widget-content">
			...
			<div class="textwidget"><?php echo balanceTags($classiera_about); ?></div>
			<?php } ?>
			...
			<div class="contact-info">
				...
				<div class="contact-info-box">
					<p><?php echo balanceTags($classieraAddress); ?></p>
			...
			<div class="contact-info">
				...
				<div class="contact-info-box">
					<p><?php echo balanceTags($classiera_phone); ?></p>
				</div>
			</div>
			<?php } ?>
		</div>
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Contact Info', 'classiera-helper' );
		$classiera_about = ! empty( $instance['classiera_about'] ) ? $instance['classiera_about'] : esc_html__( 'About Description', 'classiera-helper' );
		$address = ! empty( $instance['address'] ) ? $instance['address'] : esc_html__( 'Change Address', 'classiera-helper' );
		$classiera_email = ! empty( $instance['classiera_email'] ) ? $instance['classiera_email'] : esc_html__( 'Put Your Email Here', 'classiera-helper' );
		$classiera_phone = ! empty( $instance['classiera_phone'] ) ? $instance['classiera_phone'] : esc_html__( 'Change Phone', 'classiera-helper' );
		
		?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'classiera_logo' )); ?>"><?php esc_html_e( 'Show Logo?', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'classiera_about_info' )); ?>"><?php esc_html_e( 'Show About Description?', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'classiera-helper' ); ?></label> 
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'classiera_about' )); ?>"><?php esc_html_e( 'About Description:', 'classiera-helper' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address:', 'classiera-helper' ); ?></label> 
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'classiera_email' )); ?>"><?php esc_html_e( 'Email:', 'classiera-helper' ); ?></label> 
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'classiera_phone' )); ?>"><?php esc_html_e( 'Phone Number:', 'classiera-helper' ); ?></label> 
