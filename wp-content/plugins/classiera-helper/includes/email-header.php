	...
	<div style="width: 100%;">
		<div class="classiera-email-topbar" style="background:#232323; padding: 5px 30px;">
            ...
            <div class="classiera-column-3" style="width: 25%; display: inline-block;">
                ...
                <a href="tel:<?php echo esc_html($classieraPhone); ?>" style="text-decoration: none; color: #aaaaaa; font-size:12px; font-family: 'Lato', sans-serif;"><?php echo esc_html($classieraPhone); ?></a>
            </div>
