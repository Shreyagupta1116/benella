...
class classiera_social_widget extends WP_Widget {
	public function __construct() {		
		$widget_ops = array( 'classname' => 'classiera_social_widget', 'description' => esc_html__('A widget that displays your social icons', 'classiera-helper') );		
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'classiera_social_widget' );		
		parent::__construct( 'classiera_social_widget', esc_html__('Classiera: Social Icons', 'classiera-helper'), $widget_ops, $control_ops );		
	}	
	/**
	...
	function form( $instance ) {
		...
		<p><?php esc_html_e( 'Note: Set your social links in the Theme Options', 'classiera-helper' ); ?></p>
		
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'facebook' )); ?>"><?php esc_html_e( 'Show Facebook', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter' )); ?>"><?php esc_html_e( 'Show Twitter', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>"><?php esc_html_e( 'Show Pinterest', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bloglovin' )); ?>"><?php esc_html_e( 'Show Flickr', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'googleplus' )); ?>"><?php esc_html_e( 'Show Google Plus', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'youtube' )); ?>"><?php esc_html_e( 'Show YouTube', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'rss' )); ?>"><?php esc_html_e( 'Show Vimeo', 'classiera-helper' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'instagram' )); ?>"><?php esc_html_e( 'Show Instagram', 'classiera-helper' ); ?>:</label>
...
function register_classiera_social_widget() {
    register_widget( 'classiera_social_widget' );
}
add_action( 'widgets_init', 'register_classiera_social_widget' );
?>