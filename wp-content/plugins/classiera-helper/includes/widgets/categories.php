...
class ClassieracategoryWidget extends WP_Widget {
    public function __construct() {		
		...
		parent::__construct( 'ClassieracategoryWidget', esc_html__( 'Classiera Categories', 'classiera-helper' ), $widget_ops );
    }
       ...
       ?>
		...
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('counter')); ?>">
				<?php esc_html_e('Counter:', 'classiera-helper');?>
			</label>
...
function ClassieracategoryWidget() {
    register_widget( 'ClassieracategoryWidget' );
}
add_action( 'widgets_init', 'ClassieracategoryWidget' );
 ?>